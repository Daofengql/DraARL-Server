...
// IsWeChatEnabled 检查微信小程序配置是否可用
func (c *Configuration) IsWeChatEnabled() bool {
	return strings.TrimSpace(c.WeChat.AppID) != "" && strings.TrimSpace(c.WeChat.AppSecret) != ""
}
