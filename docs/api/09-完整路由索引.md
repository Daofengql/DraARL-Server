...
| POST | /api/client-resources/:resource_id/releases/:release_id/artifacts/complete | Admin | 完成资源文件直传 |
| POST | /api/client-resources/:resource_id/releases/:release_id/publish | Admin | 发布资源版本 |
| POST | /api/client-resources/:resource_id/releases/:release_id/withdraw | Admin | 撤回资源版本 |
| DELETE | /api/client-resources/:resource_id/releases/:release_id | Admin | 删除资源版本草稿 |
