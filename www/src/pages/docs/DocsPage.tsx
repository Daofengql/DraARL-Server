...
export function DocsPage() {
  ...
  return (
    <Stack spacing={3}>
      ...
      >
        <CardContent>
          <Stack spacing={2}>
            ...
            >
              <Chip
                icon={<EditIcon sx={{ color: 'white !important' }} />}
                label="已完成注册并审核通过"
              ...
              />
              <Chip
                icon={<Radio sx={{ color: 'white !important' }} />}
                label="拥有有效的业余电台呼号"
                sx={{ bgcolor: 'rgba(255,255,255,0.2)', color: 'white' }}
              />
            </Stack>
      ...
      {/* 报文结构 */}
      <CollapsibleSection title="报文结构" icon={<Code color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Typography variant="body1">
...
最小报文：90 字节`}
      ...
      {/* 数据包类型 */}
      <CollapsibleSection title="数据包类型" icon={<CloudSync color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Typography variant="body1">
      ...
      {/* 设备型号 */}
      <CollapsibleSection title="设备型号" icon={<Radio color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Typography variant="body1">
      ...
      <CollapsibleSection title="设备认证流程" icon={<Security color="primary" />}>
        <Stack spacing={2}>
          ...
          <AlertBox type="warning">
            <Typography variant="subtitle2" gutterBottom>安全机制</Typography>
            <Typography variant="body2">
              为防止暴力破解，平台采用阶梯封禁机制：
            </Typography>
      ...
      {/* 字符编码规则 */}
      <CollapsibleSection title="字符编码规则" icon={<Code color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Typography variant="body1">
      ...
      {/* 常见问题 */}
      <CollapsibleSection title="常见问题" icon={<Security color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Paper variant="outlined" sx={{ p: 2 }}>
            <Typography variant="subtitle2" color="primary" gutterBottom>
              Q: 设备显示认证失败怎么办？
      ...
      {/* 版本历史 */}
      <CollapsibleSection title="协议版本历史" icon={<Code color="primary" />} defaultExpanded={false}>
        <Stack spacing={2}>
          <Box sx={{ overflowX: 'auto' }}>
            <InfoTable
              headers={['版本', '日期', '说明']}
...
function AlertBox({
  ...
  const colors = {
    info: { bg: 'info.50', border: 'info.main', icon: 'ℹ️' },
    warning: { bg: 'warning.50', border: 'warning.main', icon: '⚠️' },
    error: { bg: 'error.50', border: 'error.main', icon: '❌' },
  }
