...
def build_application_doc():
    ...
    add_table(doc, ["项目", "建议填写", "依据/核对"], [
        ...
        ["版本号", VERSION, "仓库 VERSION 为 v2.0.0-alpha6；证书建议使用稳定申报口径，勿把 alpha 当作功能版本。"],
    ...
    add_table(doc, ["字段", "填报草案", "需确认事项"], [
        ...
        ["版本号", VERSION, "确认是否按 V2.0 申报；不要把 v2.0.0-alpha6 与 V2.0 混用。"],
    ...
    add_table(doc, ["核对项", "当前仓库线索", "提交前动作"], [
        ...
        ["版本快照", "VERSION=v2.0.0-alpha6，当前为 alpha 预发布版本", "在登记前打 tag、保存源码压缩包和 SHA-256。"],
    ], widths=[1.3, 2.7, 2.55])
